...
public class Security {
	...
	public static class clientDatabase {
		...
		public static boolean updateTable(String id, String first, int b1,
				String last, int b2, String address, String city, String state,
		...
		public static boolean addCustomer(String first, String last,
			...
			vphone = valid(phone);
			vemail = valid(email);
			String insert = "INSERT INTO info(first,last,address,city,state,zip,email,primaryPhone) VALUES (AES_ENCRYPT('"
					+ vfirst
					+ "', SHA2('a1767a2TE6LsoL4bCg161LbqzpHn97d7',512)),"
					+ " AES_ENCRYPT('"
					+ vlast
